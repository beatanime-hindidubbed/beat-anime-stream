...
export default function VideoPlayer({
  ...
  const handleSeekBarTouchStart = useCallback(
    ...
    [playing, duration, seekPreviewToTime]
  );
  ...
  const handleContainerTouchEnd = useCallback(
    ...
    [longPressActive, speed, flashCenter, flashWatermark]
  );
    ...
    <div ref={wrapperRef} className="relative">
      ...
      >
        <video
          ...
          onPlay={() => {
            setPlaying(true);
            if (!isSeeking.current) wasPlayingRef.current = true;
          }}
          onPause={() => {
            setPlaying(false);
          }}
          ...
          >
            {settingsPanel === "main" && (
              <div className="py-1">
                ...
                <button
                  onClick={() => setSettingsPanel("boost" as any)}
                  className="flex items-center justify-between w-full px-2 sm:px-4 py-1 sm:py-2 text-[10px] sm:text-sm text-white/90 hover:bg-white/10 active:bg-white/15 transition-colors"
                >
                  <span className="flex items-center gap-2">
                ...
                {[
                  ...
                  >
                    ...
                    <span
                      className={`w-7 h-3.5 sm:w-9 sm:h-5 rounded-full transition-colors flex items-center ${
